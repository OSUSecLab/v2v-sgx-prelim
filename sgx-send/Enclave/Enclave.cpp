...
sgx_status_t prepare_broadcast( char *encMessageOut, size_t encMessageOutLen) {
...
// this function is used only in the received code side 

sgx_status_t receive_broadcast(sgx_sealed_data_t* sealed_data, size_t sealed_size, char *rcvdEncMessageIn, size_t rcvdEncMessageInLen,  char *resultOut, size_t resultOutLen) {
